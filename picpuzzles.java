...
import java.awt.*;
import javax.swing.*;
class picpuzzles extends JFrame implements ActionListener{
...
JLabel l2=new JLabel("NOTE: This icon has power to swap with neighbour icon ==>");
